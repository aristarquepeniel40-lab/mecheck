...
cohérence des dates, unicité des labels d'indicateurs, présence des
datasets référencés, complétude du cadre logique. Complémentaire à
[medata](https://github.com/aristarquepeniel40-lab/medata) (qui
vérifie un dataset isolé) : `mecheck` vérifie les relations *entre*
